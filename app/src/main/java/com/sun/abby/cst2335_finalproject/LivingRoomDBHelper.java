...
public class LivingRoomDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    LivingRoomEntry.COLUMN_NAME_ACCESSCOUNT + INT_TYPE + " )";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_NAME + " values ( null, ?, ?)",
                new String[]{String.valueOf(R.string.livingroom_television), "0"});
        db.execSQL("insert into " + TABLE_NAME + " values ( null, ?, ?)",
                new String[]{String.valueOf(R.string.livingroom_lights), "0"});
        db.execSQL("insert into " + TABLE_NAME + " values ( null, ?, ?)",
                new String[]{String.valueOf(R.string.livingroom_blinds), "0"});
    }
